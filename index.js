...
const feed = new Feed({
	title: 'sina news',
	description: 'sina news zhibo',
	link: 'https://abuqi.github.io/sina-news',
	language: 'zh-CN',
	generator: 'sina news feed generator',
	feedLinks: {
		json: 'https://abuqi.github.io/sina-news/rss.json',
		rss: 'https://abuqi.github.io/sina-news/rss.xml'
	},
});
